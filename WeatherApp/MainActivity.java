...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setIcon(R.mipmap.weather_icon);

        ForecastAdapter = new ArrayAdapter<String>(this,
                R.layout.list_item, R.id.listView_textView,
        ...
        private String[] getDataFromJson(String forecastJsonStr, int numDays) throws JSONException {
            ...
            try {
                ...
                for (int i = 0; i < length; i++) {
                    ...
                    double highT = temperatureObj.getDouble(OWM_MAX);

                    double lowT = temperatureObj.getDouble(OWM_MIN);
...
public void reLoad(){
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.action_map){
            ...
            Uri geoLocation = Uri.parse("geo:" + posLat + "," + posLong+"?z=15");
